			...
			<div class="page-content">
				<?php
					while ( have_posts() ) : the_post();
						get_template_part( 'template-parts/content', 'single-lesson' );
						...
						the_post_navigation( array(
							'next_text' => '<span class="meta-nav" aria-hidden="true">' . __( 'Next', 'novolearn' ) . '</span> ' .
								'<span class="screen-reader-text">' . __( 'Next lesson:', 'novolearn' ) . '</span> ' .
								'<span class="post-title">%title</span>',
							'prev_text' => '<span class="meta-nav" aria-hidden="true">' . __( 'Previous', 'novolearn' ) . '</span> ' .
								'<span class="screen-reader-text">' . __( 'Previous lesson:', 'novolearn' ) . '</span> ' .
								'<span class="post-title">%title</span>',
						) );
					endwhile;
				?>
